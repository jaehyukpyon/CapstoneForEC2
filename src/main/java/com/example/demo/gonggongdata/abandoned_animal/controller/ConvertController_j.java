...
@Log4j2
public class ConvertController_j {

    @GetMapping("/convert")
    public ResponseEntity<?> convert(@RequestParam(required = false, defaultValue = "1.0") String x,
                                     @RequestParam(required = false, defaultValue = "1.0") String y) {
